...
public class ListAdapterThread extends BaseAdapter implements Filterable{
    private Context context;
    SimpleDateFormat Ftgl=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private List<thread> list,filterd;
    private int index;
...
//            cari3="ict2015";
    ...
    public ListAdapterThread(Context context, List<thread> list) {
...
//            Utils.saveImage(bitmap, fname, coba.this);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        thread thr =filterd.get(position);
...
////
        ...
        txt_Com.setText(thr.getComment()+" Comment");
    ...
    private class MahasiswaFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<thread> filteredData = new ArrayList<thread>();
...
//                }
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filterd = (List<thread>) results.values;
