...
public class ListAdapterPetShop extends BaseAdapter implements Filterable{
    private Context context;
    private List<PetShop> list,filterd;
    private int index;
...
//            cari3="ict2015";
    ...
    public ListAdapterPetShop(Context context, List<PetShop> list) {
    ...
    private class MahasiswaFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<PetShop> filteredData = new ArrayList<PetShop>();
            FilterResults result = new FilterResults();
            String filterString = constraint.toString().toLowerCase();
            for(PetShop mhs: list){
                //ori
...
//                }
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filterd = (List<PetShop>) results.values;
