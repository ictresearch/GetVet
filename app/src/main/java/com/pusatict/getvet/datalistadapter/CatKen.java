...
public class CatKen {
    ...
    public CatKen(Integer id, String nama, String alamat, String detail) {
        this.id = id;
        this.nama = nama;
        this.alamat = alamat;
        this.detail = detail;
    ...
    public void setNamaDok(String namaCatken) {
        NamaCatken = namaCatken;
    }
