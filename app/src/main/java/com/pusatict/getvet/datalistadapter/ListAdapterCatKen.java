...
public class ListAdapterCatKen extends BaseAdapter implements Filterable{
    private Context context;
    private List<CatKen> list,filterd;
    private int index;
...
//            cari3="ict2015";
    ...
    public ListAdapterCatKen(Context context, List<CatKen> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CatKen shop =filterd.get(position);
    ...
    private class MahasiswaFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<CatKen> filteredData = new ArrayList<CatKen>();
...
//                }
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filterd = (List<CatKen>) results.values;
