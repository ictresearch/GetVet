...
//		File dir = new File(sdcard.getAbsolutePath()+"/dir");
		String patch=c.getFilesDir()+"/dir";
...
//			Toast.makeText(c, "Image saved", Toast.LENGTH_SHORT).show();
	...
	public static void saveImage1(Bitmap bmp, String name, Context c) {
		ByteArrayOutputStream bytes = new ByteArrayOutputStream();

		bmp.compress(Bitmap.CompressFormat.JPEG, 94, bytes);
//		File sdcard	= Environment.getExternalStorageDirectory();
//		File dir = new File(sdcard.getAbsolutePath()+"/dir");
		String patch=c.getFilesDir()+"/dir";
		File dir = new File(patch);
