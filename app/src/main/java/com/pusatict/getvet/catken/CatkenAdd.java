 ...
 */
public class CatkenAdd extends Activity {
...
//    public static String URL = "http://www.getsimplebisnis.com/Download/getvet/vetphotos/upload.php";
    //uploadToServer
    public static String URL = "http://www.getsimplebisnis.com/index.php/api/catkencoba";
    //UploadToServer2
    public static String URL1 = "http://www.getsimplebisnis.com/index.php/api/catkencoba2";
    public static String delete="http://www.getsimplebisnis.com/index.php/api/catkencoba3";
    //API Save Pet Shop /savedata
    public static String url="http://getsimplebisnis.com/index.php/api/insertcatken";
    //API Update Klinik / upadateKlinik
    public static String url1="http://getsimplebisnis.com/index.php/api/ubahcatken";
    //API Select Kota /autocomplite
    public static String url2="http://getsimplebisnis.com/index.php/api/kota";
    //API Select Namashop Autocomplite/autocomplitenama
    public static String url3="http://getsimplebisnis.com/index.php/api/viewcatken";
    //API Update Kota /kotaupdate
    public static String url4="http://getsimplebisnis.com/index.php/api/insertkota";
    //API Select PetShop/selectklinik
    public static String url5="http://getsimplebisnis.com/index.php/api/catkenby";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.catken_add);
...
//                new DownloadImage().execute(Parsing.getString("foto"));
    ...
    public void deleteGambar(String name){
        String patch=CatkenAdd.this.getFilesDir()+"/dir";
...
//            String url2="http://getsimplebisnis.com/index.php/api/viewklinik";
            ...
            try {
                ...
                JSONArray jsonArray = json.getJSONArray("viewcatken");

                namaklinik mas=null;
                for(int i = 0; i < jsonArray.length(); i++){
                    JSONObject obj = jsonArray.getJSONObject(i);
                    mas=new namaklinik();
                    mas.setKtnama(obj.getString("cknama"));
                    list.add(mas);
                    Log.d("eror", "data lengt: " + jsonArray.length());
                }
    ...
    public class updateKlinik extends AsyncTask<String,String ,String> {
        ...
        DBAdapter db=new DBAdapter(CatkenAdd.this);
        Bundle Parsing=getIntent().getExtras();
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(CatkenAdd.this);
        ...
        protected String doInBackground(String... params) {
            ...
            nvp.add(new BasicNameValuePair("ckid", id));
            nvp.add(new BasicNameValuePair("cknama", strNama));
            nvp.add(new BasicNameValuePair("ckalamat", strAlamat));
            nvp.add(new BasicNameValuePair("ckkontak", strKontak));
            nvp.add(new BasicNameValuePair("ckkota", strKota));
            nvp.add(new BasicNameValuePair("ckjasa", strPelayanan));
            nvp.add(new BasicNameValuePair("ckjadwal", strJadwal));
//            nvp.add(new BasicNameValuePair("uid", uid));

            JSONObject json = jsonParser.makeHttpRequest(url1, "POST", nvp);
            try {
                success = json.getString("ubahcatken");
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(ba1!=null) {
                ...
                toast = Toast.makeText(getApplicationContext(), " Your cattery or kennel has been successfully updated ",
                        Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER, 0, 0);
                toast.show();
...
//            }
    ...
    public class savedata extends AsyncTask<String,String ,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            nvp.add(new BasicNameValuePair("ckjasa", strPelayanan));
            nvp.add(new BasicNameValuePair("ckjadwal", strJadwal));
            nvp.add(new BasicNameValuePair("ckfoto", urlfoto));
    ...
    public void isiBtnClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatkenAdd.this, MainActivity.class);
...
//            String url="http://getsimplebisnis.com/index.php/api/klinikby";
            List<NameValuePair> nvp = new ArrayList<NameValuePair>();
            nvp.add(new BasicNameValuePair("cknama", etxNama.getText().toString()));
            JSONObject json = jsonParser.makeHttpRequest(url5, "POST", nvp);
            try {
                success="1";
                JSONArray jsonArray = json.getJSONArray("getcatken");
...
//                    list3.add(dok);
        ...
        protected void onPostExecute(String s) {
            ...
            pDialog.dismiss();
            etxNama.setText(catken.getNama());
            etxAlamat.setText(catken.getAlamat());
            etxKontak.setText(catken.getDetail());
            actKota.setText(catken.getKota());
            etxPelayanan.setText(catken.getPelayanan());
            etxJadwal.setText(catken.getJadwal());
        }
    }
    public class uploadToServer extends AsyncTask<Void, Void, String> {

        private ProgressDialog pd = new ProgressDialog(CatkenAdd.this);
        Bundle Parsing=getIntent().getExtras();
...
//
        ...
        protected String doInBackground(Void... params) {
            namafoto=namafoto.replace("http://www.getsimplebisnis.com/Download/getvet/catkenphotos/","");
...
//            }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(CatkenAdd.this, CatkenList.class);
        startActivity(intent);
        finish();
...
//                }
    ...
    private class DownloadImage extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            Utils.saveImage1(result, fname, CatkenAdd.this);
            decodeFile(CatkenAdd.this.getFilesDir().toString() + "/dir/k.jpg");
            pDialog.dismiss();
        }
    }
}
