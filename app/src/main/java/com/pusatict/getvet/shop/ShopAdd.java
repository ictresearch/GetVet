 ...
 */
public class ShopAdd extends Activity {
...
//    public static String URL = "http://www.getsimplebisnis.com/Download/getvet/vetphotos/upload.php";
    public static String URL = "http://www.getsimplebisnis.com/index.php/api/shopcoba";
    public static String URL1 = "http://www.getsimplebisnis.com/index.php/api/shopcoba2";
    //API Save Pet Shop
    public static String url="http://getsimplebisnis.com/index.php/api/insertpetshop";
    //API Update Klinik
    public static String url1="http://getsimplebisnis.com/index.php/api/ubahpetshop";
    //API Select Kota
    public static String url2="http://getsimplebisnis.com/index.php/api/kota";
    //API Select Namashop Autocomplite
    public static String url3="http://getsimplebisnis.com/index.php/api/viewpetshop";
    //API Update Kota
    public static String url4="http://getsimplebisnis.com/index.php/api/insertkota";
    //API Select PetShop
    public static String url5="http://getsimplebisnis.com/index.php/api/petshopby";
...
//                new DownloadImage().execute(Parsing.getString("foto"));
    ...
    public void deleteGambar(String name){
        String patch=ShopAdd.this.getFilesDir()+"/dir";
...
//            String url2="http://getsimplebisnis.com/index.php/api/viewklinik";
            ...
            try {
                ...
                JSONArray jsonArray = json.getJSONArray("viewshop");

                namaklinik mas=null;
                for(int i = 0; i < jsonArray.length(); i++){
                    JSONObject obj = jsonArray.getJSONObject(i);
                    mas=new namaklinik();
                    mas.setKtnama(obj.getString("spnama"));
                    list.add(mas);
                    Log.d("eror", "data lengt: " + jsonArray.length());
                }
    ...
    public class updateKlinik extends AsyncTask<String,String ,String> {
        ...
        DBAdapter db=new DBAdapter(ShopAdd.this);
        Bundle Parsing=getIntent().getExtras();
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ShopAdd.this);
        ...
        protected String doInBackground(String... params) {
            ...
            nvp.add(new BasicNameValuePair("spid", id));
            nvp.add(new BasicNameValuePair("spnama", strNama));
            nvp.add(new BasicNameValuePair("spalamat", strAlamat));
            nvp.add(new BasicNameValuePair("spkontak", strKontak));
            nvp.add(new BasicNameValuePair("spkota", strKota));
            nvp.add(new BasicNameValuePair("spjasa", strPelayanan));
            nvp.add(new BasicNameValuePair("spjadwal", strJadwal));
//            nvp.add(new BasicNameValuePair("uid", uid));

            JSONObject json = jsonParser.makeHttpRequest(url1, "POST", nvp);
            try {
                success = json.getString("ubahshop");
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(ba1!=null) {
                ...
                toast = Toast.makeText(getApplicationContext(), " Your pet shop's has been successfully updated ",
                        Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER, 0, 0);
                toast.show();
...
//            }
    ...
    public class savedata extends AsyncTask<String,String ,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            nvp.add(new BasicNameValuePair("spjasa", strPelayanan));
            nvp.add(new BasicNameValuePair("spjadwal", strJadwal));
            nvp.add(new BasicNameValuePair("spfoto", urlfoto));
    ...
    public void isiBtnClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShopAdd.this, MainActivity.class);
...
//            String url="http://getsimplebisnis.com/index.php/api/klinikby";
            List<NameValuePair> nvp = new ArrayList<NameValuePair>();
            nvp.add(new BasicNameValuePair("spnama", etxNama.getText().toString()));
            JSONObject json = jsonParser.makeHttpRequest(url5, "POST", nvp);
            try {
                success="1";
                JSONArray jsonArray = json.getJSONArray("getshop");
...
//                    list3.add(dok);
        ...
        protected void onPostExecute(String s) {
            ...
            pDialog.dismiss();
            etxNama.setText(shop.getNama());
            etxAlamat.setText(shop.getAlamat());
            etxKontak.setText(shop.getDetail());
            actKota.setText(shop.getKota());
            etxPelayanan.setText(shop.getPelayanan());
            etxJadwal.setText(shop.getJadwal());
        }
    }
    public class uploadToServer extends AsyncTask<Void, Void, String> {

        private ProgressDialog pd = new ProgressDialog(ShopAdd.this);
        Bundle Parsing=getIntent().getExtras();
...
//
        ...
        protected String doInBackground(Void... params) {
            namafoto=namafoto.replace("http://www.getsimplebisnis.com/Download/getvet/shopphotos/","");
...
//            if(!namafoto.equals("null")){
            ...
            String delete="http://www.getsimplebisnis.com/index.php/api/shopcoba3";
...
//            }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(ShopAdd.this, ShopList.class);
        startActivity(intent);
        finish();
...
//                }
    ...
    private class DownloadImage extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            Utils.saveImage1(result, fname, ShopAdd.this);
            decodeFile(ShopAdd.this.getFilesDir().toString() + "/dir/k.jpg");
            pDialog.dismiss();
        }
    }
}
